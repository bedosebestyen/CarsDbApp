...
namespace DYRQO6_HFT_2022231.Endpoint
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IRepository<CarShop>, CarShopRepository>();
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "DYRQO6_HFT_2022231.Endpoint", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "DYRQO6_HFT_2022231.Endpoint v1"));
            }
